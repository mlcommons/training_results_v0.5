...
from resnet import train_runner
...
flags.DEFINE_integer(
    'num_prefetch_threads', default=8,
    help=('Number of prefetch threads in CPU for the input pipeline'))

flags.DEFINE_bool(
    'prefetch_depth_auto_tune', default=False,
    help=('Number of prefetch threads in CPU for the input pipeline'))
...
flags.DEFINE_boolean(
    'mlperf_logging', default=True, help=('Enable MLPERF debug logging.'))
...
def resnet_model_fn(features, labels, mode, params):
  ...
  if FLAGS.mlperf_logging:
    mlperf_log.resnet_print(
        key=mlperf_log.INPUT_MEAN_SUBTRACTION, value=MEAN_RGB)
