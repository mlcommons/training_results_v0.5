...
class EvaluationUtilsTest(tf.test.TestCase):
  ...
  def testEvaluate(self):
    output = "third_party.tensorflow_models.mlperf.models.rough.nmt_gpu/testdata/deen_output"
    ref_bpe = "third_party.tensorflow_models.mlperf.models.rough.nmt_gpu/testdata/deen_ref_bpe"
    ref_spm = "third_party.tensorflow_models.mlperf.models.rough.nmt_gpu/testdata/deen_ref_spm"
  ...
  def testAccuracy(self):
    pred_output = "third_party.tensorflow_models.mlperf.models.rough.nmt_gpu/testdata/pred_output"
    label_ref = "third_party.tensorflow_models.mlperf.models.rough.nmt_gpu/testdata/label_ref"
