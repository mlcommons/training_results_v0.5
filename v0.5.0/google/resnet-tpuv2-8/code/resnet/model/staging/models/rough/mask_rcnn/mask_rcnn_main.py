...
flags.DEFINE_float('num_epochs', 15, 'Number of epochs for training')
...
def train_with_dynamic_shapes(params, tpu_cluster_resolver, max_steps,
                              iterations_per_loop):
  ...
  with tpu_strategy.scope():
    computation = tpu_strategy.call_for_each_tower(multiple_steps_fn)
